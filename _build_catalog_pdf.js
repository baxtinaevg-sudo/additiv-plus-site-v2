...
// Paths
const srcHtml = path.join(__dirname, '.business', 'marketing', 'catalog-sss', 'preview.html');
const tmpDir = 'C:\\Temp';
const tmpHtml = path.join(tmpDir, 'catalog.html');
const tmpPdf = path.join(tmpDir, 'catalog-sss-2026.pdf');
const finalPdf = path.join(__dirname, '.business', 'marketing', 'catalog-sss', 'catalog-sss-2026.pdf');
...
const cmd = `"${edge}" --headless --disable-gpu --print-to-pdf="${tmpPdf}" --no-margins "file:///C:/Temp/catalog.html"`;
