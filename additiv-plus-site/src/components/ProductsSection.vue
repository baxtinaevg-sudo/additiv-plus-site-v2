...
const categories = [
  {
    ...
    subgroups: [
      {
        icon: IconCube,
        title: 'Эфиры целлюлозы',
        description: 'Водоудержание, реология и удобоукладываемость смесей.',
      },
      {
        icon: IconDrop,
        title: 'Пластификаторы',
        description: 'Повышение подвижности и снижение водоцементного отношения.',
      },
      {
        icon: IconBolt,
        title: 'Ускорители',
        description: 'Сокращение сроков схватывания и твердения.',
      },
      {
        icon: IconFlask,
        title: 'Замедлители',
        description: 'Регулирование сроков схватывания для длительной работы.',
      },
      {
        icon: IconWind,
        title: 'Пеногасители',
        description: 'Предотвращение образования нежелательных воздушных пор.',
      },
      {
        icon: IconCog,
        title: 'Модификаторы',
        description: 'Комплексные добавки для специальных свойств смесей.',
      },
      {
        icon: IconLayers,
        title: 'Реологические добавки',
        description: 'Управление вязкостью и текучестью растворных смесей.',
      },
      {
        icon: IconShield,
        title: 'Воздухововлекающие добавки',
        description: 'Повышение морозостойкости и долговечности.',
      },
    ],
  },
  {
  ...
  {
    title: 'Гибридные клея и герметики',
