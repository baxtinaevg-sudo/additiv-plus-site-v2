...
const stats = [
  { value: 4, suffix: '', label: 'Лаборатории', target: 4 },
  { value: 9, suffix: '+', label: 'Лет на рынке', target: 9 },
  { value: 2000, suffix: '', label: 'Тонн/год — проектная мощность', target: 2000 },
  { value: 100, suffix: '+', label: 'Лет суммарного стажа', target: 100 },
]
